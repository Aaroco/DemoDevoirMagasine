...
public class FrmMenu extends JFrame
{
    ...
    Magazine magazineSelectionee;
    Article artticleSelectionee;
    ...
    public FrmMenu()
    {
        ...
        // A compléter ici
        mdl = new ModelJTable();
        mdl.loadDatasMagasines(mesMagazines);
        ...
        tblMagazines.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                // A compléter ici
                int numMagasine = Integer.parseInt( tblMagazines.getValueAt(tblMagazines.getSelectedRow(),0).toString());

                for (Magazine mgz : mesMagazines)
                {
                    if(mgz.getNumMagazine() == numMagasine)
                    {

                        mdl = new ModelJTable();
                        mdl.loadDatasArticles(mgz.getLesArticles());
                        tblArticles.setModel(mdl);
                        //lblMontantMagazine.setText(String.valueOf(mgz.CalculerMontantMagazine()));
                        magazineSelectionee= mgz;
                        break;
                    }
                }
                txtMontantMagazine.setText(String.valueOf(magazineSelectionee.CalculerMontantMagazine()));
        ...
        tblArticles.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                // A compléter ici
                String nomArticles = ( tblArticles.getValueAt(tblArticles.getSelectedRow(),0).toString());

                for (Article article : magazineSelectionee.getLesArticles())
                {
                    if(article.getTitreArticle().equals(nomArticles))
                    {
                        artticleSelectionee= article;
                        txtMontantArticle.setText(String.valueOf(artticleSelectionee.CalculerMontantArticle()));
                        break;
                    }
                }
        ...
        btnAjouterArticle.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Veuillez sélectionner un magasine","Choix du magasine",JOptionPane.WARNING_MESSAGE);
                }
                else if(txtTitreArticle.getText().equals(""))
                {
                    JOptionPane.showMessageDialog(null, "Veuillez ecrire un titre","Choix du titre",JOptionPane.WARNING_MESSAGE);
                }
